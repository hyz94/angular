...
export class RegisterComponent implements OnInit {
   ...
   // http://10.3.136.55:8181/insertAppUsers?username=qqq&password=123
  ...
  clickRegister(e){
      ...
      if(num<=1){
          ...
          console.log('成功注册');
          console.log('您注册的手机号码为:',this.username);
          this.alertdisplay = 'block';
          console.log('号码为:',numStr);
          // http://10.3.136.55:8181/insertAppUsers?username=qqq&password=123
          this.http.get('insertAppUsers',{username:numStr}).then((res)=>{
              console.log(res);
          })
          this.alertStr = '注册成功,跳转登录页面';
          setTimeout(()=>{
            this.alertdisplay ='none';
